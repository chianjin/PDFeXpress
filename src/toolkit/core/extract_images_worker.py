    ...
    try:
        ...
        for file_path in input_files:
            with pymupdf.open(file_path) as doc:
                for page in doc:
                    total_images_to_extract += len(page.get_images(full=True))
        progress_queue.put(("INIT", total_images_to_extract))
                ...
                for page in doc:
                    ...
                    for img_info in img_list:
                        ...
                        if w >= min_width and h >= min_height:
                            ...
                            img_filename = f"{pdf_path_obj.stem}_xref_{xref}.{img_ext}"
