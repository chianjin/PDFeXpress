            ...
            if i in page_text_map:
                ...
                if h_pos == 'left':
                    ...
                    x = (
                        h_margin_points
                        if (i + 1) % 2 == 0
                        else page_rect.width - text_width - h_margin_points
                    )
                elif h_pos == 'inside':
                    x = (
                        page_rect.width - text_width - h_margin_points
                        if (i + 1) % 2 == 0
                        else h_margin_points
                    )
                else:
                    x = (page_rect.width - text_width) / 2
                ...
                page.insert_text(
                    (x, y), text, fontname=fitz_font_name, fontsize=font_size
                )
