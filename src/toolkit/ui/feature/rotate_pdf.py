# src/toolkit/ui/feature/rotate_pdf.py
...
class RotatePDFApp(ttk.Frame, TaskRunnerMixin):
    def __init__(self, master, **kwargs):
        ...
        self.save_to_same_folder_checkbox = ttk.Checkbutton(
            self.option_frame,
            text=_("Save to the same folder"),
        ...
        self.start_button = ttk.Button(bottom_frame, text=_("Rotate"), command=self.run_task_from_ui)
