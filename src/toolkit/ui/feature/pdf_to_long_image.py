...
class PDFToLongImageApp(ttk.Frame, TaskRunnerMixin):
    def __init__(self, master, **kwargs):
        ...
        ttk.Label(self.option_frame, text=_("DPI:")).pack(side="left", padx=(10, 0), pady=5)
        ...
        ttk.Label(self.option_frame, text=_("Image Quality:")).pack(side="left", padx=(10, 0), pady=5)
        self.quality_var = tk.IntVar(value=75)
        self.quality_spinbox = ttk.Spinbox(self.option_frame, from_=1, to=100, increment=1, textvariable=self.quality_var,
                                         width=5)
