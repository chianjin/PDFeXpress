...
class UiMergePDF(ttk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.LabelFrameName.configure(font='{Microsoft YaHei UI} 16 {bold}', text='合并 PDF')
        ...
        self.FramePDFList.configure(height='200', text='PDF 列表', width='200')
        ...
        self.FrameMergedPDFFile.configure(height='200', text='输出文件', width='200')
