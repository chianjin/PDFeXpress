...
class UiMergePDF(ttk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.LabelFrameName.configure(font='{Microsoft YaHei UI} 16 {bold}', text='Merge PDF')
        ...
        self.TreeViewPDFList.heading('ColumnDirName', anchor='w', text='Folder')
        self.TreeViewPDFList.heading('ColumnFileName', anchor='w', text='File Name')
        ...
        self.FramePDFList.configure(height='200', text='PDF List', width='200')
