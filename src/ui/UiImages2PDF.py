...
class UiImages2PDF(ttk.Frame):
    def __init__(self, master=None, **kw):
        ...
        self.LabelFrameName.configure(font='{Microsoft YaHei UI} 16 {bold}', text=_('Images to PDF'))
        ...
        self.Separator1 = ttk.Separator(self.FrameImageList)
        self.Separator1.configure(orient='horizontal')
        self.Separator1.pack(fill='x', padx='4', pady='4', side='top')
